<div>
    ...
    <h2 class="fs-14 text-titulo mb-5">Creación, edición y eliminación de categorías</h2>

    <div class="row gx-sm-5">

        <div class="col-sm-12 col-md-4 bg-grey">
            ...
            <div class="form-group text-center">
                <button id="btn-agregar-event" wire:click="save" wire:target="save" class="btn-agregar">Agregar Categoria</button>
            </div>
						...
						<div class="col-sm-6">
							<div class="mb-3">
								...
								<div class="ratio ratio-1x1 bg-img w-75 mx-auto rounded-4" style="background-image: url({{ asset($imageEdit ? $imageEdit -> temporaryUrl() : $editArray['image']) }});">
									<div>
										<a onclick="$('.imageEditUpload').click()" class="rounded-circle shadow bg-dark-4 p-2 d-block position-absolute top-0 start-100 translate-middle"><img src="http://localhost:8000/img/icos/ico-edit.svg" width="16" height="16" class="float-start f-invert"></a>
									</div>
								</div>
