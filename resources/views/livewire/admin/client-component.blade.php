<div>
    ...
    <h2 class="fs-14 text-titulo mb-5">Creación, edición y eliminación de clientes</h2>
    ...
    <div class="row gx-sm-5">
        ...
        <div class="col-4 bg-grey">
            ...
            <div class="form-group text-center">
                <button id="btn-agregar-event" wire:click="save" wire:target="save" class="btn-agregar">Agregar Cliente</button>
            </div>
