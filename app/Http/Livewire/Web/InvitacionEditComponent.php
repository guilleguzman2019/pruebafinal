...
class InvitacionEditComponent extends Component
{
    ...
    public function render()
    {
        ...
        if ($this-> card -> template -> name == 'Boho') {
            ...
            return view('template_edit.boho2' , compact('events', 'fotos', 'regalos', 'pa'))
        ...
        if ($this-> card -> template -> name == 'Chic') {
            ...
            return view('template_edit.Chic2' , compact('events', 'fotos', 'regalos', 'pa'))
                        ->extends('layouts.invitacion') 
                        ->section('content');
        }
        ...
        if ($this-> card -> template -> name == 'Romantic') {
            ...
            return view('template_edit.romantic2' , compact('events', 'fotos', 'regalos', 'pa'))
                        ->extends('layouts.invitacion') 
                        ->section('content');
        }
        ...
        if ($this-> card -> template -> name == 'Western') {
          ...
          return view('template_edit.western' , compact('events', 'fotos', 'regalos', 'pa'))
                        ->extends('layouts.invitacion') 
                        ->section('content');
        }
